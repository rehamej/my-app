...
function Certificates() {
  return (
    ...
    <div className="services flex justify-around mt-10 gap-10">
        <div className="service flex flex-col items-center text-center flex-1 basis-1/3 justify-center">
            <img src="https://i.ibb.co/VMcP0Y2/download.png" className="w-28 object-cover" />
            <h2 className="text-xl mt-4">Certified Management Consultant (CMC)</h2>
        </div>
        <div className="service flex flex-col items-center text-center flex-1 basis-1/3">
            <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0g-s_dsEmT744CKtqPqxsfOMTKR1O8gurxQ&s"
                alt="Content Creation"
                className="w-28 object-cover"
            />
            <h2 className="text-xl mt-4">Content Marketing Certification by HubSpot Academy</h2>
        </div>
        <div className="service flex flex-col items-center text-center flex-1 basis-1/3">
            <img
                ...
                className="w-28 object-cover"
            />
            <h2 className="text-xl mt-4">Direct Response Copywriting Certification by AWAI (American Writers & Artists Institute)</h2>
        </div>
    </div>
